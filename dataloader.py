...
labels = ((226, 24, 24),(112,205,77),(147,75,207),(200,209,80),(255, 140, 49),(103,207,153),(202,77,144),
              (86,109,54),(158,144,205),(196,137,54),(119,184,198),(100,45,49),(200,198,154),(58,70,80),(195,135,126))
...
def get_data(path=""):
    ...
    label_face_onehot = np.zeros([n_face,15]).astype(('int32'))
...
class plydataset(Dataset):
    ...
    def __init__(self, path="/content/TSGCNet/data/train/"):
        self.root_path = path
        self.file_list = [file for file in os.listdir(path) if file.endswith(".ply")]
    def __len__(self):
